...
######################################parsing networks################################################################
        ...
        (self.feed('res5c_relu')
             ...
             # .conv(3, 3, 128, 1, 1, biased=True, relu=True, name='res5d_branch2c_parsing'))

# ######################################pose networks################################################################
#         (self.feed('res4b22_relu')
#              .conv(1, 1, 512, 1, 1, biased=True, relu=True, name='res5a_branch1_pose'))

#         (self.feed('res4b22_relu')
#              .conv(1, 1, 512, 1, 1, biased=True, relu=True, name='res5a_branch2a_pose')
#              .atrous_conv(3, 3, 512, 4, padding='SAME', biased=True, relu=True, name='res5a_branch2b_pose')
#              .conv(3, 3, 512, 1, 1, biased=True, relu=True, name='res5a_branch2c_pose'))

#         (self.feed('res5a_branch1_pose', 
#                    'res5a_branch2c_pose')
#              .add(name='res5a_pose')
#              .relu(name='res5a_relu_pose')
#              .conv(1, 1, 512, 1, 1, biased=True, relu=True, name='res5b_branch2a_pose')
#              .atrous_conv(3, 3, 512, 4, padding='SAME', biased=True, relu=True, name='res5b_branch2b_pose')
#              .conv(3, 3, 512, 1, 1, biased=True, relu=True, name='res5b_branch2c_pose'))

#         (self.feed('res5a_relu_pose', 
#                    'res5b_branch2c_pose')
#              .add(name='res5b_pose')
#              .relu(name='res5b_relu_pose')
#              .conv(1, 1, 512, 1, 1, biased=True, relu=True, name='res5c_branch2a_pose')
#              .atrous_conv(3, 3, 512, 4, padding='SAME', biased=True, relu=True, name='res5c_branch2b_pose')
#              .conv(3, 3, 512, 1, 1, biased=True, relu=True, name='res5c_branch2c_pose'))

#         (self.feed('res5b_relu_pose', 
#                    'res5c_branch2c_pose')
#              .add(name='res5c_pose')
#              .relu(name='res5c_relu_pose'))

#         (self.feed('res5c_relu_pose')
#              .conv(3, 3, 16, 1, 1, biased=True, relu=False, name='fc1_pose'))

#         (self.feed('res5c_relu_pose')
#              .conv(3, 3, 256, 1, 1, biased=True, relu=True, name='res5d_branch2a_pose')
#              .conv(3, 3, 128, 1, 1, biased=True, relu=True, name='res5d_branch2b_pose'))
