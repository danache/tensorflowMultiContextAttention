...
# tmpOut1 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut1_U', padding='SAME'))
# tmpOut1 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut1_share_param', reuse=False):
            (self.feed('Stack5_tmpOut1_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp
        (self.feed('Stack5_tmpOut1_spConv1',
                   'Stack5_tmpOut1_U')
         .add(name='Stack5_tmpOut1_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut1_Qtemp1'))

# tmpOut1 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut1_share_param', reuse=True):
            (self.feed('Stack5_tmpOut1_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp2
        (self.feed('Stack5_tmpOut1_spConv1',
                   'Stack5_tmpOut1_U')
         .add(name='Stack5_tmpOut1_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut1_Qtemp2'))

# tmpOut1 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut1_share_param', reuse=True):
            (self.feed('Stack5_tmpOut1_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp
        (self.feed('Stack5_tmpOut1_spConv1',
                   'Stack5_tmpOut1_U')
         .add(name='Stack5_tmpOut1_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut1_Qtemp3'))
# tmpOut1 att pfeat
        (self.feed('Stack5_tmpOut1_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut1_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut1_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut1_pfeat_multiply'))

        (self.feed('Stack5_tmpOut1_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut1_s', padding='SAME'))




# attention map for part2
# tmpOut2 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut2_U', padding='SAME'))
# tmpOut2 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut2_share_param', reuse=False):
            (self.feed('Stack5_tmpOut2_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp
        (self.feed('Stack5_tmpOut2_spConv1',
                   'Stack5_tmpOut2_U')
         .add(name='Stack5_tmpOut2_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut2_Qtemp1'))

# tmpOut2 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut2_share_param', reuse=True):
            (self.feed('Stack5_tmpOut2_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp2
        (self.feed('Stack5_tmpOut2_spConv1',
                   'Stack5_tmpOut2_U')
         .add(name='Stack5_tmpOut2_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut2_Qtemp2'))

# tmpOut2 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut2_share_param', reuse=True):
            (self.feed('Stack5_tmpOut2_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp
        (self.feed('Stack5_tmpOut2_spConv1',
                   'Stack5_tmpOut2_U')
         .add(name='Stack5_tmpOut2_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut2_Qtemp3'))
# tmpOut2 att pfeat
        (self.feed('Stack5_tmpOut2_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut2_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut2_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut2_pfeat_multiply'))

        (self.feed('Stack5_tmpOut2_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut2_s', padding='SAME'))




# attention map for part3
# tmpOut3 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut3_U', padding='SAME'))
# tmpOut3 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut3_share_param', reuse=False):
            (self.feed('Stack5_tmpOut3_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp
        (self.feed('Stack5_tmpOut3_spConv1',
                   'Stack5_tmpOut3_U')
         .add(name='Stack5_tmpOut3_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut3_Qtemp1'))

# tmpOut3 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut3_share_param', reuse=True):
            (self.feed('Stack5_tmpOut3_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp2
        (self.feed('Stack5_tmpOut3_spConv1',
                   'Stack5_tmpOut3_U')
         .add(name='Stack5_tmpOut3_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut3_Qtemp2'))

# tmpOut3 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut3_share_param', reuse=True):
            (self.feed('Stack5_tmpOut3_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp
        (self.feed('Stack5_tmpOut3_spConv1',
                   'Stack5_tmpOut3_U')
         .add(name='Stack5_tmpOut3_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut3_Qtemp3'))
# tmpOut3 att pfeat
        (self.feed('Stack5_tmpOut3_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut3_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut3_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut3_pfeat_multiply'))

        (self.feed('Stack5_tmpOut3_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut3_s', padding='SAME'))
...
# tmpOut4 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut4_U', padding='SAME'))
# tmpOut4 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut4_share_param', reuse=False):
            (self.feed('Stack5_tmpOut4_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp
        (self.feed('Stack5_tmpOut4_spConv1',
                   'Stack5_tmpOut4_U')
         .add(name='Stack5_tmpOut4_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut4_Qtemp1'))

# tmpOut4 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut4_share_param', reuse=True):
            (self.feed('Stack5_tmpOut4_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp2
        (self.feed('Stack5_tmpOut4_spConv1',
                   'Stack5_tmpOut4_U')
         .add(name='Stack5_tmpOut4_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut4_Qtemp2'))

# tmpOut4 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut4_share_param', reuse=True):
            (self.feed('Stack5_tmpOut4_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp
        (self.feed('Stack5_tmpOut4_spConv1',
                   'Stack5_tmpOut4_U')
         .add(name='Stack5_tmpOut4_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut4_Qtemp3'))
# tmpOut4 att pfeat
        (self.feed('Stack5_tmpOut4_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut4_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut4_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut4_pfeat_multiply'))

        (self.feed('Stack5_tmpOut4_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut4_s', padding='SAME'))
...
# tmpOut5 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut5_U', padding='SAME'))
# tmpOut5 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut5_share_param', reuse=False):
            (self.feed('Stack5_tmpOut5_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp
        (self.feed('Stack5_tmpOut5_spConv1',
                   'Stack5_tmpOut5_U')
         .add(name='Stack5_tmpOut5_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut5_Qtemp1'))

# tmpOut5 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut5_share_param', reuse=True):
            (self.feed('Stack5_tmpOut5_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp2
        (self.feed('Stack5_tmpOut5_spConv1',
                   'Stack5_tmpOut5_U')
         .add(name='Stack5_tmpOut5_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut5_Qtemp2'))

# tmpOut5 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut5_share_param', reuse=True):
            (self.feed('Stack5_tmpOut5_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp
        (self.feed('Stack5_tmpOut5_spConv1',
                   'Stack5_tmpOut5_U')
         .add(name='Stack5_tmpOut5_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut5_Qtemp3'))
# tmpOut5 att pfeat
        (self.feed('Stack5_tmpOut5_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut5_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut5_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut5_pfeat_multiply'))

        (self.feed('Stack5_tmpOut5_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut5_s', padding='SAME'))
...
# tmpOut6 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut6_U', padding='SAME'))
# tmpOut6 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut6_share_param', reuse=False):
            (self.feed('Stack5_tmpOut6_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp
        (self.feed('Stack5_tmpOut6_spConv1',
                   'Stack5_tmpOut6_U')
         .add(name='Stack5_tmpOut6_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut6_Qtemp1'))

# tmpOut6 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut6_share_param', reuse=True):
            (self.feed('Stack5_tmpOut6_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp2
        (self.feed('Stack5_tmpOut6_spConv1',
                   'Stack5_tmpOut6_U')
         .add(name='Stack5_tmpOut6_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut6_Qtemp2'))

# tmpOut6 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut6_share_param', reuse=True):
            (self.feed('Stack5_tmpOut6_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp
        (self.feed('Stack5_tmpOut6_spConv1',
                   'Stack5_tmpOut6_U')
         .add(name='Stack5_tmpOut6_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut6_Qtemp3'))
# tmpOut6 att pfeat
        (self.feed('Stack5_tmpOut6_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut6_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut6_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut6_pfeat_multiply'))

        (self.feed('Stack5_tmpOut6_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut6_s', padding='SAME'))
...
# tmpOut7 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut7_U', padding='SAME'))
# tmpOut7 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut7_share_param', reuse=False):
            (self.feed('Stack5_tmpOut7_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp
        (self.feed('Stack5_tmpOut7_spConv1',
                   'Stack5_tmpOut7_U')
         .add(name='Stack5_tmpOut7_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut7_Qtemp1'))

# tmpOut7 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut7_share_param', reuse=True):
            (self.feed('Stack5_tmpOut7_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp2
        (self.feed('Stack5_tmpOut7_spConv1',
                   'Stack5_tmpOut7_U')
         .add(name='Stack5_tmpOut7_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut7_Qtemp2'))

# tmpOut7 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut7_share_param', reuse=True):
            (self.feed('Stack5_tmpOut7_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp
        (self.feed('Stack5_tmpOut7_spConv1',
                   'Stack5_tmpOut7_U')
         .add(name='Stack5_tmpOut7_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut7_Qtemp3'))
# tmpOut7 att pfeat
        (self.feed('Stack5_tmpOut7_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut7_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut7_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut7_pfeat_multiply'))

        (self.feed('Stack5_tmpOut7_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut7_s', padding='SAME'))
...
# tmpOut8 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut8_U', padding='SAME'))
# tmpOut8 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut8_share_param', reuse=False):
            (self.feed('Stack5_tmpOut8_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp
        (self.feed('Stack5_tmpOut8_spConv1',
                   'Stack5_tmpOut8_U')
         .add(name='Stack5_tmpOut8_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut8_Qtemp1'))

# tmpOut8 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut8_share_param', reuse=True):
            (self.feed('Stack5_tmpOut8_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp2
        (self.feed('Stack5_tmpOut8_spConv1',
                   'Stack5_tmpOut8_U')
         .add(name='Stack5_tmpOut8_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut8_Qtemp2'))

# tmpOut8 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut8_share_param', reuse=True):
            (self.feed('Stack5_tmpOut8_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp
        (self.feed('Stack5_tmpOut8_spConv1',
                   'Stack5_tmpOut8_U')
         .add(name='Stack5_tmpOut8_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut8_Qtemp3'))
# tmpOut8 att pfeat
        (self.feed('Stack5_tmpOut8_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut8_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut8_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut8_pfeat_multiply'))

        (self.feed('Stack5_tmpOut8_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut8_s', padding='SAME'))
...
# tmpOut9 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut9_U', padding='SAME'))
# tmpOut9 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut9_share_param', reuse=False):
            (self.feed('Stack5_tmpOut9_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp
        (self.feed('Stack5_tmpOut9_spConv1',
                   'Stack5_tmpOut9_U')
         .add(name='Stack5_tmpOut9_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut9_Qtemp1'))

# tmpOut9 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut9_share_param', reuse=True):
            (self.feed('Stack5_tmpOut9_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp2
        (self.feed('Stack5_tmpOut9_spConv1',
                   'Stack5_tmpOut9_U')
         .add(name='Stack5_tmpOut9_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut9_Qtemp2'))

# tmpOut9 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut9_share_param', reuse=True):
            (self.feed('Stack5_tmpOut9_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp
        (self.feed('Stack5_tmpOut9_spConv1',
                   'Stack5_tmpOut9_U')
         .add(name='Stack5_tmpOut9_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut9_Qtemp3'))
# tmpOut9 att pfeat
        (self.feed('Stack5_tmpOut9_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut9_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut9_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut9_pfeat_multiply'))

        (self.feed('Stack5_tmpOut9_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut9_s', padding='SAME'))
...
# tmpOut10 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut10_U', padding='SAME'))
# tmpOut10 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut10_share_param', reuse=False):
            (self.feed('Stack5_tmpOut10_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp
        (self.feed('Stack5_tmpOut10_spConv1',
                   'Stack5_tmpOut10_U')
         .add(name='Stack5_tmpOut10_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut10_Qtemp1'))

# tmpOut10 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut10_share_param', reuse=True):
            (self.feed('Stack5_tmpOut10_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp2
        (self.feed('Stack5_tmpOut10_spConv1',
                   'Stack5_tmpOut10_U')
         .add(name='Stack5_tmpOut10_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut10_Qtemp2'))

# tmpOut10 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut10_share_param', reuse=True):
            (self.feed('Stack5_tmpOut10_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp
        (self.feed('Stack5_tmpOut10_spConv1',
                   'Stack5_tmpOut10_U')
         .add(name='Stack5_tmpOut10_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut10_Qtemp3'))
# tmpOut10 att pfeat
        (self.feed('Stack5_tmpOut10_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut10_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut10_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut10_pfeat_multiply'))

        (self.feed('Stack5_tmpOut10_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut10_s', padding='SAME'))
...
# tmpOut11 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut11_U', padding='SAME'))
# tmpOut11 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut11_share_param', reuse=False):
            (self.feed('Stack5_tmpOut11_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp
        (self.feed('Stack5_tmpOut11_spConv1',
                   'Stack5_tmpOut11_U')
         .add(name='Stack5_tmpOut11_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut11_Qtemp1'))

# tmpOut11 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut11_share_param', reuse=True):
            (self.feed('Stack5_tmpOut11_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp2
        (self.feed('Stack5_tmpOut11_spConv1',
                   'Stack5_tmpOut11_U')
         .add(name='Stack5_tmpOut11_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut11_Qtemp2'))

# tmpOut11 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut11_share_param', reuse=True):
            (self.feed('Stack5_tmpOut11_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp
        (self.feed('Stack5_tmpOut11_spConv1',
                   'Stack5_tmpOut11_U')
         .add(name='Stack5_tmpOut11_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut11_Qtemp3'))
# tmpOut11 att pfeat
        (self.feed('Stack5_tmpOut11_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut11_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut11_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut11_pfeat_multiply'))

        (self.feed('Stack5_tmpOut11_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut11_s', padding='SAME'))
...
# tmpOut12 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut12_U', padding='SAME'))
# tmpOut12 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut12_share_param', reuse=False):
            (self.feed('Stack5_tmpOut12_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp
        (self.feed('Stack5_tmpOut12_spConv1',
                   'Stack5_tmpOut12_U')
         .add(name='Stack5_tmpOut12_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut12_Qtemp1'))

# tmpOut12 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut12_share_param', reuse=True):
            (self.feed('Stack5_tmpOut12_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp2
        (self.feed('Stack5_tmpOut12_spConv1',
                   'Stack5_tmpOut12_U')
         .add(name='Stack5_tmpOut12_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut12_Qtemp2'))

# tmpOut12 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut12_share_param', reuse=True):
            (self.feed('Stack5_tmpOut12_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp
        (self.feed('Stack5_tmpOut12_spConv1',
                   'Stack5_tmpOut12_U')
         .add(name='Stack5_tmpOut12_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut12_Qtemp3'))
# tmpOut12 att pfeat
        (self.feed('Stack5_tmpOut12_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut12_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut12_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut12_pfeat_multiply'))

        (self.feed('Stack5_tmpOut12_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut12_s', padding='SAME'))
...
# tmpOut13 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut13_U', padding='SAME'))
# tmpOut13 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut13_share_param', reuse=False):
            (self.feed('Stack5_tmpOut13_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp
        (self.feed('Stack5_tmpOut13_spConv1',
                   'Stack5_tmpOut13_U')
         .add(name='Stack5_tmpOut13_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut13_Qtemp1'))

# tmpOut13 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut13_share_param', reuse=True):
            (self.feed('Stack5_tmpOut13_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp2
        (self.feed('Stack5_tmpOut13_spConv1',
                   'Stack5_tmpOut13_U')
         .add(name='Stack5_tmpOut13_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut13_Qtemp2'))

# tmpOut13 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut13_share_param', reuse=True):
            (self.feed('Stack5_tmpOut13_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp
        (self.feed('Stack5_tmpOut13_spConv1',
                   'Stack5_tmpOut13_U')
         .add(name='Stack5_tmpOut13_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut13_Qtemp3'))
# tmpOut13 att pfeat
        (self.feed('Stack5_tmpOut13_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut13_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut13_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut13_pfeat_multiply'))

        (self.feed('Stack5_tmpOut13_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut13_s', padding='SAME'))
...
# tmpOut14 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut14_U', padding='SAME'))
# tmpOut14 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut14_share_param', reuse=False):
            (self.feed('Stack5_tmpOut14_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp
        (self.feed('Stack5_tmpOut14_spConv1',
                   'Stack5_tmpOut14_U')
         .add(name='Stack5_tmpOut14_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut14_Qtemp1'))

# tmpOut14 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut14_share_param', reuse=True):
            (self.feed('Stack5_tmpOut14_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp2
        (self.feed('Stack5_tmpOut14_spConv1',
                   'Stack5_tmpOut14_U')
         .add(name='Stack5_tmpOut14_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut14_Qtemp2'))

# tmpOut14 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut14_share_param', reuse=True):
            (self.feed('Stack5_tmpOut14_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp
        (self.feed('Stack5_tmpOut14_spConv1',
                   'Stack5_tmpOut14_U')
         .add(name='Stack5_tmpOut14_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut14_Qtemp3'))
# tmpOut14 att pfeat
        (self.feed('Stack5_tmpOut14_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut14_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut14_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut14_pfeat_multiply'))

        (self.feed('Stack5_tmpOut14_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut14_s', padding='SAME'))
...
# tmpOut15 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut15_U', padding='SAME'))
# tmpOut15 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut15_share_param', reuse=False):
            (self.feed('Stack5_tmpOut15_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp
        (self.feed('Stack5_tmpOut15_spConv1',
                   'Stack5_tmpOut15_U')
         .add(name='Stack5_tmpOut15_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut15_Qtemp1'))

# tmpOut15 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut15_share_param', reuse=True):
            (self.feed('Stack5_tmpOut15_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp2
        (self.feed('Stack5_tmpOut15_spConv1',
                   'Stack5_tmpOut15_U')
         .add(name='Stack5_tmpOut15_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut15_Qtemp2'))

# tmpOut15 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut15_share_param', reuse=True):
            (self.feed('Stack5_tmpOut15_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp
        (self.feed('Stack5_tmpOut15_spConv1',
                   'Stack5_tmpOut15_U')
         .add(name='Stack5_tmpOut15_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut15_Qtemp3'))
# tmpOut15 att pfeat
        (self.feed('Stack5_tmpOut15_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut15_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut15_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut15_pfeat_multiply'))

        (self.feed('Stack5_tmpOut15_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut15_s', padding='SAME'))
...
# tmpOut16 att U input: Stack5_att_pfeat_multiply
        (self.feed('Stack5_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut16_U', padding='SAME'))
# tmpOut16 att i=1 conv  C(1)
        with tf.variable_scope('Stack5_tmpOut16_share_param', reuse=False):
            (self.feed('Stack5_tmpOut16_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp
        (self.feed('Stack5_tmpOut16_spConv1',
                   'Stack5_tmpOut16_U')
         .add(name='Stack5_tmpOut16_Qtemp1_add')
         .sigmoid(name='Stack5_tmpOut16_Qtemp1'))

# tmpOut16 att i=2 conv  C(2)
        with tf.variable_scope('Stack5_tmpOut16_share_param', reuse=True):
            (self.feed('Stack5_tmpOut16_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp2
        (self.feed('Stack5_tmpOut16_spConv1',
                   'Stack5_tmpOut16_U')
         .add(name='Stack5_tmpOut16_Qtemp2_add')
         .sigmoid(name='Stack5_tmpOut16_Qtemp2'))

# tmpOut16 att i=3 conv  C(3)
        with tf.variable_scope('Stack5_tmpOut16_share_param', reuse=True):
            (self.feed('Stack5_tmpOut16_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp
        (self.feed('Stack5_tmpOut16_spConv1',
                   'Stack5_tmpOut16_U')
         .add(name='Stack5_tmpOut16_Qtemp3_add')
         .sigmoid(name='Stack5_tmpOut16_Qtemp3'))
# tmpOut16 att pfeat
        (self.feed('Stack5_tmpOut16_Qtemp3')
         .replicate(256, 3, name='Stack5_tmpOut16_pfeat_replicate'))

        (self.feed('Stack5_att_pfeat_multiply',
                   'Stack5_tmpOut16_pfeat_replicate')
         .multiply2(name='Stack5_tmpOut16_pfeat_multiply'))

        (self.feed('Stack5_tmpOut16_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack5_tmpOut16_s', padding='SAME'))


        (self.feed('Stack5_tmpOut1_s',
                   'Stack5_tmpOut2_s',
                   'Stack5_tmpOut3_s',
                   'Stack5_tmpOut4_s',
                   'Stack5_tmpOut5_s',
                   ...
                   'Stack5_tmpOut15_s',
                   'Stack5_tmpOut16_s')
         .stack(axis = 3,  name='Stack5_Heatmap'))        

        (self.feed('Stack5_tmpOut1_s')
            .printLayer(name='printLayer14'))
        (self.feed('Stack5_tmpOut2_s')
            .printLayer(name='printLayer15'))
        (self.feed('Stack5_tmpOut3_s')
            .printLayer(name='printLayer16'))
        (self.feed('Stack5_tmpOut4_s')
...
# attention map for part1
# tmpOut1 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut1_U', padding='SAME'))
# tmpOut1 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut1_share_param', reuse=False):
            (self.feed('Stack6_tmpOut1_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp
        (self.feed('Stack6_tmpOut1_spConv1',
                   'Stack6_tmpOut1_U')
         .add(name='Stack6_tmpOut1_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut1_Qtemp1'))

# tmpOut1 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut1_share_param', reuse=True):
            (self.feed('Stack6_tmpOut1_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp2
        (self.feed('Stack6_tmpOut1_spConv1',
                   'Stack6_tmpOut1_U')
         .add(name='Stack6_tmpOut1_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut1_Qtemp2'))

# tmpOut1 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut1_share_param', reuse=True):
            (self.feed('Stack6_tmpOut1_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp
        (self.feed('Stack6_tmpOut1_spConv1',
                   'Stack6_tmpOut1_U')
         .add(name='Stack6_tmpOut1_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut1_Qtemp3'))
# tmpOut1 att pfeat
        (self.feed('Stack6_tmpOut1_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut1_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut1_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut1_pfeat_multiply'))

        (self.feed('Stack6_tmpOut1_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut1_s', padding='SAME'))




# attention map for part2
# tmpOut2 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut2_U', padding='SAME'))
# tmpOut2 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut2_share_param', reuse=False):
            (self.feed('Stack6_tmpOut2_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp
        (self.feed('Stack6_tmpOut2_spConv1',
                   'Stack6_tmpOut2_U')
         .add(name='Stack6_tmpOut2_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut2_Qtemp1'))

# tmpOut2 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut2_share_param', reuse=True):
            (self.feed('Stack6_tmpOut2_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp2
        (self.feed('Stack6_tmpOut2_spConv1',
                   'Stack6_tmpOut2_U')
         .add(name='Stack6_tmpOut2_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut2_Qtemp2'))

# tmpOut2 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut2_share_param', reuse=True):
            (self.feed('Stack6_tmpOut2_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp
        (self.feed('Stack6_tmpOut2_spConv1',
                   'Stack6_tmpOut2_U')
         .add(name='Stack6_tmpOut2_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut2_Qtemp3'))
# tmpOut2 att pfeat
        (self.feed('Stack6_tmpOut2_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut2_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut2_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut2_pfeat_multiply'))

        (self.feed('Stack6_tmpOut2_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut2_s', padding='SAME'))




# attention map for part3
# tmpOut3 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut3_U', padding='SAME'))
# tmpOut3 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut3_share_param', reuse=False):
            (self.feed('Stack6_tmpOut3_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp
        (self.feed('Stack6_tmpOut3_spConv1',
                   'Stack6_tmpOut3_U')
         .add(name='Stack6_tmpOut3_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut3_Qtemp1'))

# tmpOut3 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut3_share_param', reuse=True):
            (self.feed('Stack6_tmpOut3_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp2
        (self.feed('Stack6_tmpOut3_spConv1',
                   'Stack6_tmpOut3_U')
         .add(name='Stack6_tmpOut3_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut3_Qtemp2'))

# tmpOut3 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut3_share_param', reuse=True):
            (self.feed('Stack6_tmpOut3_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp
        (self.feed('Stack6_tmpOut3_spConv1',
                   'Stack6_tmpOut3_U')
         .add(name='Stack6_tmpOut3_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut3_Qtemp3'))
# tmpOut3 att pfeat
        (self.feed('Stack6_tmpOut3_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut3_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut3_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut3_pfeat_multiply'))

        (self.feed('Stack6_tmpOut3_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut3_s', padding='SAME'))
...
# attention map for part4
# tmpOut4 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut4_U', padding='SAME'))
# tmpOut4 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut4_share_param', reuse=False):
            (self.feed('Stack6_tmpOut4_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp
        (self.feed('Stack6_tmpOut4_spConv1',
                   'Stack6_tmpOut4_U')
         .add(name='Stack6_tmpOut4_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut4_Qtemp1'))

# tmpOut4 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut4_share_param', reuse=True):
            (self.feed('Stack6_tmpOut4_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp2
        (self.feed('Stack6_tmpOut4_spConv1',
                   'Stack6_tmpOut4_U')
         .add(name='Stack6_tmpOut4_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut4_Qtemp2'))

# tmpOut4 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut4_share_param', reuse=True):
            (self.feed('Stack6_tmpOut4_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp
        (self.feed('Stack6_tmpOut4_spConv1',
                   'Stack6_tmpOut4_U')
         .add(name='Stack6_tmpOut4_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut4_Qtemp3'))
# tmpOut4 att pfeat
        (self.feed('Stack6_tmpOut4_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut4_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut4_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut4_pfeat_multiply'))

        (self.feed('Stack6_tmpOut4_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut4_s', padding='SAME'))
...
# attention map for part5
# tmpOut5 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut5_U', padding='SAME'))
# tmpOut5 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut5_share_param', reuse=False):
            (self.feed('Stack6_tmpOut5_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp
        (self.feed('Stack6_tmpOut5_spConv1',
                   'Stack6_tmpOut5_U')
         .add(name='Stack6_tmpOut5_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut5_Qtemp1'))

# tmpOut5 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut5_share_param', reuse=True):
            (self.feed('Stack6_tmpOut5_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp2
        (self.feed('Stack6_tmpOut5_spConv1',
                   'Stack6_tmpOut5_U')
         .add(name='Stack6_tmpOut5_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut5_Qtemp2'))

# tmpOut5 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut5_share_param', reuse=True):
            (self.feed('Stack6_tmpOut5_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp
        (self.feed('Stack6_tmpOut5_spConv1',
                   'Stack6_tmpOut5_U')
         .add(name='Stack6_tmpOut5_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut5_Qtemp3'))
# tmpOut5 att pfeat
        (self.feed('Stack6_tmpOut5_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut5_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut5_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut5_pfeat_multiply'))

        (self.feed('Stack6_tmpOut5_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut5_s', padding='SAME'))
...
# attention map for part6
# tmpOut6 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut6_U', padding='SAME'))
# tmpOut6 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut6_share_param', reuse=False):
            (self.feed('Stack6_tmpOut6_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp
        (self.feed('Stack6_tmpOut6_spConv1',
                   'Stack6_tmpOut6_U')
         .add(name='Stack6_tmpOut6_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut6_Qtemp1'))

# tmpOut6 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut6_share_param', reuse=True):
            (self.feed('Stack6_tmpOut6_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp2
        (self.feed('Stack6_tmpOut6_spConv1',
                   'Stack6_tmpOut6_U')
         .add(name='Stack6_tmpOut6_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut6_Qtemp2'))

# tmpOut6 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut6_share_param', reuse=True):
            (self.feed('Stack6_tmpOut6_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp
        (self.feed('Stack6_tmpOut6_spConv1',
                   'Stack6_tmpOut6_U')
         .add(name='Stack6_tmpOut6_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut6_Qtemp3'))
# tmpOut6 att pfeat
        (self.feed('Stack6_tmpOut6_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut6_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut6_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut6_pfeat_multiply'))

        (self.feed('Stack6_tmpOut6_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut6_s', padding='SAME'))
...
# attention map for part7
# tmpOut7 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut7_U', padding='SAME'))
# tmpOut7 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut7_share_param', reuse=False):
            (self.feed('Stack6_tmpOut7_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp
        (self.feed('Stack6_tmpOut7_spConv1',
                   'Stack6_tmpOut7_U')
         .add(name='Stack6_tmpOut7_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut7_Qtemp1'))

# tmpOut7 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut7_share_param', reuse=True):
            (self.feed('Stack6_tmpOut7_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp2
        (self.feed('Stack6_tmpOut7_spConv1',
                   'Stack6_tmpOut7_U')
         .add(name='Stack6_tmpOut7_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut7_Qtemp2'))

# tmpOut7 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut7_share_param', reuse=True):
            (self.feed('Stack6_tmpOut7_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp
        (self.feed('Stack6_tmpOut7_spConv1',
                   'Stack6_tmpOut7_U')
         .add(name='Stack6_tmpOut7_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut7_Qtemp3'))
# tmpOut7 att pfeat
        (self.feed('Stack6_tmpOut7_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut7_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut7_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut7_pfeat_multiply'))

        (self.feed('Stack6_tmpOut7_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut7_s', padding='SAME'))
...
# attention map for part8
# tmpOut8 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut8_U', padding='SAME'))
# tmpOut8 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut8_share_param', reuse=False):
            (self.feed('Stack6_tmpOut8_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp
        (self.feed('Stack6_tmpOut8_spConv1',
                   'Stack6_tmpOut8_U')
         .add(name='Stack6_tmpOut8_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut8_Qtemp1'))

# tmpOut8 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut8_share_param', reuse=True):
            (self.feed('Stack6_tmpOut8_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp2
        (self.feed('Stack6_tmpOut8_spConv1',
                   'Stack6_tmpOut8_U')
         .add(name='Stack6_tmpOut8_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut8_Qtemp2'))

# tmpOut8 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut8_share_param', reuse=True):
            (self.feed('Stack6_tmpOut8_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp
        (self.feed('Stack6_tmpOut8_spConv1',
                   'Stack6_tmpOut8_U')
         .add(name='Stack6_tmpOut8_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut8_Qtemp3'))
# tmpOut8 att pfeat
        (self.feed('Stack6_tmpOut8_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut8_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut8_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut8_pfeat_multiply'))

        (self.feed('Stack6_tmpOut8_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut8_s', padding='SAME'))
...
# attention map for part9
# tmpOut9 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut9_U', padding='SAME'))
# tmpOut9 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut9_share_param', reuse=False):
            (self.feed('Stack6_tmpOut9_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp
        (self.feed('Stack6_tmpOut9_spConv1',
                   'Stack6_tmpOut9_U')
         .add(name='Stack6_tmpOut9_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut9_Qtemp1'))

# tmpOut9 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut9_share_param', reuse=True):
            (self.feed('Stack6_tmpOut9_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp2
        (self.feed('Stack6_tmpOut9_spConv1',
                   'Stack6_tmpOut9_U')
         .add(name='Stack6_tmpOut9_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut9_Qtemp2'))

# tmpOut9 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut9_share_param', reuse=True):
            (self.feed('Stack6_tmpOut9_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp
        (self.feed('Stack6_tmpOut9_spConv1',
                   'Stack6_tmpOut9_U')
         .add(name='Stack6_tmpOut9_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut9_Qtemp3'))
# tmpOut9 att pfeat
        (self.feed('Stack6_tmpOut9_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut9_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut9_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut9_pfeat_multiply'))

        (self.feed('Stack6_tmpOut9_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut9_s', padding='SAME'))
...
# attention map for part10
# tmpOut10 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut10_U', padding='SAME'))
# tmpOut10 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut10_share_param', reuse=False):
            (self.feed('Stack6_tmpOut10_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp
        (self.feed('Stack6_tmpOut10_spConv1',
                   'Stack6_tmpOut10_U')
         .add(name='Stack6_tmpOut10_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut10_Qtemp1'))

# tmpOut10 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut10_share_param', reuse=True):
            (self.feed('Stack6_tmpOut10_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp2
        (self.feed('Stack6_tmpOut10_spConv1',
                   'Stack6_tmpOut10_U')
         .add(name='Stack6_tmpOut10_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut10_Qtemp2'))

# tmpOut10 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut10_share_param', reuse=True):
            (self.feed('Stack6_tmpOut10_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp
        (self.feed('Stack6_tmpOut10_spConv1',
                   'Stack6_tmpOut10_U')
         .add(name='Stack6_tmpOut10_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut10_Qtemp3'))
# tmpOut10 att pfeat
        (self.feed('Stack6_tmpOut10_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut10_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut10_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut10_pfeat_multiply'))

        (self.feed('Stack6_tmpOut10_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut10_s', padding='SAME'))
...
# attention map for part11
# tmpOut11 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut11_U', padding='SAME'))
# tmpOut11 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut11_share_param', reuse=False):
            (self.feed('Stack6_tmpOut11_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp
        (self.feed('Stack6_tmpOut11_spConv1',
                   'Stack6_tmpOut11_U')
         .add(name='Stack6_tmpOut11_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut11_Qtemp1'))

# tmpOut11 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut11_share_param', reuse=True):
            (self.feed('Stack6_tmpOut11_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp2
        (self.feed('Stack6_tmpOut11_spConv1',
                   'Stack6_tmpOut11_U')
         .add(name='Stack6_tmpOut11_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut11_Qtemp2'))

# tmpOut11 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut11_share_param', reuse=True):
            (self.feed('Stack6_tmpOut11_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp
        (self.feed('Stack6_tmpOut11_spConv1',
                   'Stack6_tmpOut11_U')
         .add(name='Stack6_tmpOut11_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut11_Qtemp3'))
# tmpOut11 att pfeat
        (self.feed('Stack6_tmpOut11_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut11_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut11_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut11_pfeat_multiply'))

        (self.feed('Stack6_tmpOut11_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut11_s', padding='SAME'))
...
# attention map for part12
# tmpOut12 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut12_U', padding='SAME'))
# tmpOut12 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut12_share_param', reuse=False):
            (self.feed('Stack6_tmpOut12_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp
        (self.feed('Stack6_tmpOut12_spConv1',
                   'Stack6_tmpOut12_U')
         .add(name='Stack6_tmpOut12_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut12_Qtemp1'))

# tmpOut12 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut12_share_param', reuse=True):
            (self.feed('Stack6_tmpOut12_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp2
        (self.feed('Stack6_tmpOut12_spConv1',
                   'Stack6_tmpOut12_U')
         .add(name='Stack6_tmpOut12_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut12_Qtemp2'))

# tmpOut12 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut12_share_param', reuse=True):
            (self.feed('Stack6_tmpOut12_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp
        (self.feed('Stack6_tmpOut12_spConv1',
                   'Stack6_tmpOut12_U')
         .add(name='Stack6_tmpOut12_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut12_Qtemp3'))
# tmpOut12 att pfeat
        (self.feed('Stack6_tmpOut12_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut12_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut12_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut12_pfeat_multiply'))

        (self.feed('Stack6_tmpOut12_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut12_s', padding='SAME'))
...
# attention map for part13
# tmpOut13 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut13_U', padding='SAME'))
# tmpOut13 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut13_share_param', reuse=False):
            (self.feed('Stack6_tmpOut13_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp
        (self.feed('Stack6_tmpOut13_spConv1',
                   'Stack6_tmpOut13_U')
         .add(name='Stack6_tmpOut13_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut13_Qtemp1'))

# tmpOut13 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut13_share_param', reuse=True):
            (self.feed('Stack6_tmpOut13_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp2
        (self.feed('Stack6_tmpOut13_spConv1',
                   'Stack6_tmpOut13_U')
         .add(name='Stack6_tmpOut13_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut13_Qtemp2'))

# tmpOut13 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut13_share_param', reuse=True):
            (self.feed('Stack6_tmpOut13_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp
        (self.feed('Stack6_tmpOut13_spConv1',
                   'Stack6_tmpOut13_U')
         .add(name='Stack6_tmpOut13_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut13_Qtemp3'))
# tmpOut13 att pfeat
        (self.feed('Stack6_tmpOut13_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut13_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut13_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut13_pfeat_multiply'))

        (self.feed('Stack6_tmpOut13_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut13_s', padding='SAME'))
...
# attention map for part14
# tmpOut14 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut14_U', padding='SAME'))
# tmpOut14 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut14_share_param', reuse=False):
            (self.feed('Stack6_tmpOut14_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp
        (self.feed('Stack6_tmpOut14_spConv1',
                   'Stack6_tmpOut14_U')
         .add(name='Stack6_tmpOut14_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut14_Qtemp1'))

# tmpOut14 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut14_share_param', reuse=True):
            (self.feed('Stack6_tmpOut14_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp2
        (self.feed('Stack6_tmpOut14_spConv1',
                   'Stack6_tmpOut14_U')
         .add(name='Stack6_tmpOut14_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut14_Qtemp2'))

# tmpOut14 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut14_share_param', reuse=True):
            (self.feed('Stack6_tmpOut14_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp
        (self.feed('Stack6_tmpOut14_spConv1',
                   'Stack6_tmpOut14_U')
         .add(name='Stack6_tmpOut14_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut14_Qtemp3'))
# tmpOut14 att pfeat
        (self.feed('Stack6_tmpOut14_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut14_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut14_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut14_pfeat_multiply'))

        (self.feed('Stack6_tmpOut14_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut14_s', padding='SAME'))
...
# attention map for part15
# tmpOut15 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut15_U', padding='SAME'))
# tmpOut15 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut15_share_param', reuse=False):
            (self.feed('Stack6_tmpOut15_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp
        (self.feed('Stack6_tmpOut15_spConv1',
                   'Stack6_tmpOut15_U')
         .add(name='Stack6_tmpOut15_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut15_Qtemp1'))

# tmpOut15 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut15_share_param', reuse=True):
            (self.feed('Stack6_tmpOut15_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp2
        (self.feed('Stack6_tmpOut15_spConv1',
                   'Stack6_tmpOut15_U')
         .add(name='Stack6_tmpOut15_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut15_Qtemp2'))

# tmpOut15 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut15_share_param', reuse=True):
            (self.feed('Stack6_tmpOut15_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp
        (self.feed('Stack6_tmpOut15_spConv1',
                   'Stack6_tmpOut15_U')
         .add(name='Stack6_tmpOut15_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut15_Qtemp3'))
# tmpOut15 att pfeat
        (self.feed('Stack6_tmpOut15_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut15_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut15_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut15_pfeat_multiply'))

        (self.feed('Stack6_tmpOut15_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut15_s', padding='SAME'))
...
# attention map for part16
# tmpOut16 att U input: Stack6_att_pfeat_multiply
        (self.feed('Stack6_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut16_U', padding='SAME'))
# tmpOut16 att i=1 conv  C(1)
        with tf.variable_scope('Stack6_tmpOut16_share_param', reuse=False):
            (self.feed('Stack6_tmpOut16_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp
        (self.feed('Stack6_tmpOut16_spConv1',
                   'Stack6_tmpOut16_U')
         .add(name='Stack6_tmpOut16_Qtemp1_add')
         .sigmoid(name='Stack6_tmpOut16_Qtemp1'))

# tmpOut16 att i=2 conv  C(2)
        with tf.variable_scope('Stack6_tmpOut16_share_param', reuse=True):
            (self.feed('Stack6_tmpOut16_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp2
        (self.feed('Stack6_tmpOut16_spConv1',
                   'Stack6_tmpOut16_U')
         .add(name='Stack6_tmpOut16_Qtemp2_add')
         .sigmoid(name='Stack6_tmpOut16_Qtemp2'))

# tmpOut16 att i=3 conv  C(3)
        with tf.variable_scope('Stack6_tmpOut16_share_param', reuse=True):
            (self.feed('Stack6_tmpOut16_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp
        (self.feed('Stack6_tmpOut16_spConv1',
                   'Stack6_tmpOut16_U')
         .add(name='Stack6_tmpOut16_Qtemp3_add')
         .sigmoid(name='Stack6_tmpOut16_Qtemp3'))
# tmpOut16 att pfeat
        (self.feed('Stack6_tmpOut16_Qtemp3')
         .replicate(256, 3, name='Stack6_tmpOut16_pfeat_replicate'))

        (self.feed('Stack6_att_pfeat_multiply',
                   'Stack6_tmpOut16_pfeat_replicate')
         .multiply2(name='Stack6_tmpOut16_pfeat_multiply'))

        (self.feed('Stack6_tmpOut16_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack6_tmpOut16_s', padding='SAME'))


        (self.feed('Stack6_tmpOut1_s',
                   'Stack6_tmpOut2_s',
                   'Stack6_tmpOut3_s',
                   'Stack6_tmpOut4_s',
                   'Stack6_tmpOut5_s',
                   ...
                   'Stack6_tmpOut15_s',
                   'Stack6_tmpOut16_s')
         .stack(axis = 3,  name='Stack6_Heatmap'))        
...
# attention map for part1
# tmpOut1 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut1_U', padding='SAME'))
# tmpOut1 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut1_share_param', reuse=False):
            (self.feed('Stack7_tmpOut1_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp
        (self.feed('Stack7_tmpOut1_spConv1',
                   'Stack7_tmpOut1_U')
         .add(name='Stack7_tmpOut1_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut1_Qtemp1'))

# tmpOut1 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut1_share_param', reuse=True):
            (self.feed('Stack7_tmpOut1_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp2
        (self.feed('Stack7_tmpOut1_spConv1',
                   'Stack7_tmpOut1_U')
         .add(name='Stack7_tmpOut1_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut1_Qtemp2'))

# tmpOut1 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut1_share_param', reuse=True):
            (self.feed('Stack7_tmpOut1_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp
        (self.feed('Stack7_tmpOut1_spConv1',
                   'Stack7_tmpOut1_U')
         .add(name='Stack7_tmpOut1_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut1_Qtemp3'))
# tmpOut1 att pfeat
        (self.feed('Stack7_tmpOut1_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut1_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut1_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut1_pfeat_multiply'))

        (self.feed('Stack7_tmpOut1_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut1_s', padding='SAME'))




# attention map for part2
# tmpOut2 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut2_U', padding='SAME'))
# tmpOut2 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut2_share_param', reuse=False):
            (self.feed('Stack7_tmpOut2_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp
        (self.feed('Stack7_tmpOut2_spConv1',
                   'Stack7_tmpOut2_U')
         .add(name='Stack7_tmpOut2_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut2_Qtemp1'))

# tmpOut2 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut2_share_param', reuse=True):
            (self.feed('Stack7_tmpOut2_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp2
        (self.feed('Stack7_tmpOut2_spConv1',
                   'Stack7_tmpOut2_U')
         .add(name='Stack7_tmpOut2_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut2_Qtemp2'))

# tmpOut2 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut2_share_param', reuse=True):
            (self.feed('Stack7_tmpOut2_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp
        (self.feed('Stack7_tmpOut2_spConv1',
                   'Stack7_tmpOut2_U')
         .add(name='Stack7_tmpOut2_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut2_Qtemp3'))
# tmpOut2 att pfeat
        (self.feed('Stack7_tmpOut2_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut2_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut2_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut2_pfeat_multiply'))

        (self.feed('Stack7_tmpOut2_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut2_s', padding='SAME'))




# attention map for part3
# tmpOut3 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut3_U', padding='SAME'))
# tmpOut3 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut3_share_param', reuse=False):
            (self.feed('Stack7_tmpOut3_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp
        (self.feed('Stack7_tmpOut3_spConv1',
                   'Stack7_tmpOut3_U')
         .add(name='Stack7_tmpOut3_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut3_Qtemp1'))

# tmpOut3 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut3_share_param', reuse=True):
            (self.feed('Stack7_tmpOut3_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp2
        (self.feed('Stack7_tmpOut3_spConv1',
                   'Stack7_tmpOut3_U')
         .add(name='Stack7_tmpOut3_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut3_Qtemp2'))

# tmpOut3 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut3_share_param', reuse=True):
            (self.feed('Stack7_tmpOut3_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp
        (self.feed('Stack7_tmpOut3_spConv1',
                   'Stack7_tmpOut3_U')
         .add(name='Stack7_tmpOut3_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut3_Qtemp3'))
# tmpOut3 att pfeat
        (self.feed('Stack7_tmpOut3_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut3_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut3_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut3_pfeat_multiply'))

        (self.feed('Stack7_tmpOut3_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut3_s', padding='SAME'))
...
# attention map for part4
# tmpOut4 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut4_U', padding='SAME'))
# tmpOut4 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut4_share_param', reuse=False):
            (self.feed('Stack7_tmpOut4_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp
        (self.feed('Stack7_tmpOut4_spConv1',
                   'Stack7_tmpOut4_U')
         .add(name='Stack7_tmpOut4_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut4_Qtemp1'))

# tmpOut4 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut4_share_param', reuse=True):
            (self.feed('Stack7_tmpOut4_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp2
        (self.feed('Stack7_tmpOut4_spConv1',
                   'Stack7_tmpOut4_U')
         .add(name='Stack7_tmpOut4_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut4_Qtemp2'))

# tmpOut4 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut4_share_param', reuse=True):
            (self.feed('Stack7_tmpOut4_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp
        (self.feed('Stack7_tmpOut4_spConv1',
                   'Stack7_tmpOut4_U')
         .add(name='Stack7_tmpOut4_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut4_Qtemp3'))
# tmpOut4 att pfeat
        (self.feed('Stack7_tmpOut4_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut4_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut4_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut4_pfeat_multiply'))

        (self.feed('Stack7_tmpOut4_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut4_s', padding='SAME'))
...
# attention map for part5
# tmpOut5 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut5_U', padding='SAME'))
# tmpOut5 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut5_share_param', reuse=False):
            (self.feed('Stack7_tmpOut5_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp
        (self.feed('Stack7_tmpOut5_spConv1',
                   'Stack7_tmpOut5_U')
         .add(name='Stack7_tmpOut5_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut5_Qtemp1'))

# tmpOut5 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut5_share_param', reuse=True):
            (self.feed('Stack7_tmpOut5_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp2
        (self.feed('Stack7_tmpOut5_spConv1',
                   'Stack7_tmpOut5_U')
         .add(name='Stack7_tmpOut5_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut5_Qtemp2'))

# tmpOut5 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut5_share_param', reuse=True):
            (self.feed('Stack7_tmpOut5_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp
        (self.feed('Stack7_tmpOut5_spConv1',
                   'Stack7_tmpOut5_U')
         .add(name='Stack7_tmpOut5_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut5_Qtemp3'))
# tmpOut5 att pfeat
        (self.feed('Stack7_tmpOut5_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut5_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut5_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut5_pfeat_multiply'))

        (self.feed('Stack7_tmpOut5_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut5_s', padding='SAME'))
...
# attention map for part6
# tmpOut6 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut6_U', padding='SAME'))
# tmpOut6 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut6_share_param', reuse=False):
            (self.feed('Stack7_tmpOut6_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp
        (self.feed('Stack7_tmpOut6_spConv1',
                   'Stack7_tmpOut6_U')
         .add(name='Stack7_tmpOut6_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut6_Qtemp1'))

# tmpOut6 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut6_share_param', reuse=True):
            (self.feed('Stack7_tmpOut6_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp2
        (self.feed('Stack7_tmpOut6_spConv1',
                   'Stack7_tmpOut6_U')
         .add(name='Stack7_tmpOut6_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut6_Qtemp2'))

# tmpOut6 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut6_share_param', reuse=True):
            (self.feed('Stack7_tmpOut6_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp
        (self.feed('Stack7_tmpOut6_spConv1',
                   'Stack7_tmpOut6_U')
         .add(name='Stack7_tmpOut6_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut6_Qtemp3'))
# tmpOut6 att pfeat
        (self.feed('Stack7_tmpOut6_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut6_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut6_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut6_pfeat_multiply'))

        (self.feed('Stack7_tmpOut6_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut6_s', padding='SAME'))
...
# attention map for part7
# tmpOut7 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut7_U', padding='SAME'))
# tmpOut7 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut7_share_param', reuse=False):
            (self.feed('Stack7_tmpOut7_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp
        (self.feed('Stack7_tmpOut7_spConv1',
                   'Stack7_tmpOut7_U')
         .add(name='Stack7_tmpOut7_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut7_Qtemp1'))

# tmpOut7 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut7_share_param', reuse=True):
            (self.feed('Stack7_tmpOut7_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp2
        (self.feed('Stack7_tmpOut7_spConv1',
                   'Stack7_tmpOut7_U')
         .add(name='Stack7_tmpOut7_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut7_Qtemp2'))

# tmpOut7 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut7_share_param', reuse=True):
            (self.feed('Stack7_tmpOut7_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp
        (self.feed('Stack7_tmpOut7_spConv1',
                   'Stack7_tmpOut7_U')
         .add(name='Stack7_tmpOut7_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut7_Qtemp3'))
# tmpOut7 att pfeat
        (self.feed('Stack7_tmpOut7_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut7_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut7_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut7_pfeat_multiply'))

        (self.feed('Stack7_tmpOut7_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut7_s', padding='SAME'))
...
# attention map for part8
# tmpOut8 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut8_U', padding='SAME'))
# tmpOut8 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut8_share_param', reuse=False):
            (self.feed('Stack7_tmpOut8_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp
        (self.feed('Stack7_tmpOut8_spConv1',
                   'Stack7_tmpOut8_U')
         .add(name='Stack7_tmpOut8_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut8_Qtemp1'))

# tmpOut8 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut8_share_param', reuse=True):
            (self.feed('Stack7_tmpOut8_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp2
        (self.feed('Stack7_tmpOut8_spConv1',
                   'Stack7_tmpOut8_U')
         .add(name='Stack7_tmpOut8_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut8_Qtemp2'))

# tmpOut8 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut8_share_param', reuse=True):
            (self.feed('Stack7_tmpOut8_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp
        (self.feed('Stack7_tmpOut8_spConv1',
                   'Stack7_tmpOut8_U')
         .add(name='Stack7_tmpOut8_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut8_Qtemp3'))
# tmpOut8 att pfeat
        (self.feed('Stack7_tmpOut8_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut8_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut8_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut8_pfeat_multiply'))

        (self.feed('Stack7_tmpOut8_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut8_s', padding='SAME'))
...
# attention map for part9
# tmpOut9 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut9_U', padding='SAME'))
# tmpOut9 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut9_share_param', reuse=False):
            (self.feed('Stack7_tmpOut9_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp
        (self.feed('Stack7_tmpOut9_spConv1',
                   'Stack7_tmpOut9_U')
         .add(name='Stack7_tmpOut9_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut9_Qtemp1'))

# tmpOut9 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut9_share_param', reuse=True):
            (self.feed('Stack7_tmpOut9_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp2
        (self.feed('Stack7_tmpOut9_spConv1',
                   'Stack7_tmpOut9_U')
         .add(name='Stack7_tmpOut9_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut9_Qtemp2'))

# tmpOut9 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut9_share_param', reuse=True):
            (self.feed('Stack7_tmpOut9_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp
        (self.feed('Stack7_tmpOut9_spConv1',
                   'Stack7_tmpOut9_U')
         .add(name='Stack7_tmpOut9_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut9_Qtemp3'))
# tmpOut9 att pfeat
        (self.feed('Stack7_tmpOut9_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut9_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut9_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut9_pfeat_multiply'))

        (self.feed('Stack7_tmpOut9_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut9_s', padding='SAME'))
...
# attention map for part10
# tmpOut10 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut10_U', padding='SAME'))
# tmpOut10 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut10_share_param', reuse=False):
            (self.feed('Stack7_tmpOut10_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp
        (self.feed('Stack7_tmpOut10_spConv1',
                   'Stack7_tmpOut10_U')
         .add(name='Stack7_tmpOut10_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut10_Qtemp1'))

# tmpOut10 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut10_share_param', reuse=True):
            (self.feed('Stack7_tmpOut10_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp2
        (self.feed('Stack7_tmpOut10_spConv1',
                   'Stack7_tmpOut10_U')
         .add(name='Stack7_tmpOut10_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut10_Qtemp2'))

# tmpOut10 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut10_share_param', reuse=True):
            (self.feed('Stack7_tmpOut10_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp
        (self.feed('Stack7_tmpOut10_spConv1',
                   'Stack7_tmpOut10_U')
         .add(name='Stack7_tmpOut10_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut10_Qtemp3'))
# tmpOut10 att pfeat
        (self.feed('Stack7_tmpOut10_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut10_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut10_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut10_pfeat_multiply'))

        (self.feed('Stack7_tmpOut10_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut10_s', padding='SAME'))
...
# attention map for part11
# tmpOut11 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut11_U', padding='SAME'))
# tmpOut11 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut11_share_param', reuse=False):
            (self.feed('Stack7_tmpOut11_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp
        (self.feed('Stack7_tmpOut11_spConv1',
                   'Stack7_tmpOut11_U')
         .add(name='Stack7_tmpOut11_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut11_Qtemp1'))

# tmpOut11 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut11_share_param', reuse=True):
            (self.feed('Stack7_tmpOut11_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp2
        (self.feed('Stack7_tmpOut11_spConv1',
                   'Stack7_tmpOut11_U')
         .add(name='Stack7_tmpOut11_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut11_Qtemp2'))

# tmpOut11 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut11_share_param', reuse=True):
            (self.feed('Stack7_tmpOut11_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp
        (self.feed('Stack7_tmpOut11_spConv1',
                   'Stack7_tmpOut11_U')
         .add(name='Stack7_tmpOut11_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut11_Qtemp3'))
# tmpOut11 att pfeat
        (self.feed('Stack7_tmpOut11_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut11_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut11_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut11_pfeat_multiply'))

        (self.feed('Stack7_tmpOut11_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut11_s', padding='SAME'))
...
# attention map for part12
# tmpOut12 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut12_U', padding='SAME'))
# tmpOut12 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut12_share_param', reuse=False):
            (self.feed('Stack7_tmpOut12_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp
        (self.feed('Stack7_tmpOut12_spConv1',
                   'Stack7_tmpOut12_U')
         .add(name='Stack7_tmpOut12_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut12_Qtemp1'))

# tmpOut12 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut12_share_param', reuse=True):
            (self.feed('Stack7_tmpOut12_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp2
        (self.feed('Stack7_tmpOut12_spConv1',
                   'Stack7_tmpOut12_U')
         .add(name='Stack7_tmpOut12_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut12_Qtemp2'))

# tmpOut12 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut12_share_param', reuse=True):
            (self.feed('Stack7_tmpOut12_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp
        (self.feed('Stack7_tmpOut12_spConv1',
                   'Stack7_tmpOut12_U')
         .add(name='Stack7_tmpOut12_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut12_Qtemp3'))
# tmpOut12 att pfeat
        (self.feed('Stack7_tmpOut12_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut12_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut12_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut12_pfeat_multiply'))

        (self.feed('Stack7_tmpOut12_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut12_s', padding='SAME'))
...
# attention map for part13
# tmpOut13 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut13_U', padding='SAME'))
# tmpOut13 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut13_share_param', reuse=False):
            (self.feed('Stack7_tmpOut13_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp
        (self.feed('Stack7_tmpOut13_spConv1',
                   'Stack7_tmpOut13_U')
         .add(name='Stack7_tmpOut13_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut13_Qtemp1'))

# tmpOut13 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut13_share_param', reuse=True):
            (self.feed('Stack7_tmpOut13_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp2
        (self.feed('Stack7_tmpOut13_spConv1',
                   'Stack7_tmpOut13_U')
         .add(name='Stack7_tmpOut13_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut13_Qtemp2'))

# tmpOut13 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut13_share_param', reuse=True):
            (self.feed('Stack7_tmpOut13_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp
        (self.feed('Stack7_tmpOut13_spConv1',
                   'Stack7_tmpOut13_U')
         .add(name='Stack7_tmpOut13_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut13_Qtemp3'))
# tmpOut13 att pfeat
        (self.feed('Stack7_tmpOut13_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut13_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut13_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut13_pfeat_multiply'))

        (self.feed('Stack7_tmpOut13_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut13_s', padding='SAME'))
...
# attention map for part14
# tmpOut14 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut14_U', padding='SAME'))
# tmpOut14 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut14_share_param', reuse=False):
            (self.feed('Stack7_tmpOut14_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp
        (self.feed('Stack7_tmpOut14_spConv1',
                   'Stack7_tmpOut14_U')
         .add(name='Stack7_tmpOut14_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut14_Qtemp1'))

# tmpOut14 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut14_share_param', reuse=True):
            (self.feed('Stack7_tmpOut14_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp2
        (self.feed('Stack7_tmpOut14_spConv1',
                   'Stack7_tmpOut14_U')
         .add(name='Stack7_tmpOut14_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut14_Qtemp2'))

# tmpOut14 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut14_share_param', reuse=True):
            (self.feed('Stack7_tmpOut14_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp
        (self.feed('Stack7_tmpOut14_spConv1',
                   'Stack7_tmpOut14_U')
         .add(name='Stack7_tmpOut14_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut14_Qtemp3'))
# tmpOut14 att pfeat
        (self.feed('Stack7_tmpOut14_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut14_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut14_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut14_pfeat_multiply'))

        (self.feed('Stack7_tmpOut14_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut14_s', padding='SAME'))
...
# attention map for part15
# tmpOut15 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut15_U', padding='SAME'))
# tmpOut15 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut15_share_param', reuse=False):
            (self.feed('Stack7_tmpOut15_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp
        (self.feed('Stack7_tmpOut15_spConv1',
                   'Stack7_tmpOut15_U')
         .add(name='Stack7_tmpOut15_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut15_Qtemp1'))

# tmpOut15 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut15_share_param', reuse=True):
            (self.feed('Stack7_tmpOut15_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp2
        (self.feed('Stack7_tmpOut15_spConv1',
                   'Stack7_tmpOut15_U')
         .add(name='Stack7_tmpOut15_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut15_Qtemp2'))

# tmpOut15 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut15_share_param', reuse=True):
            (self.feed('Stack7_tmpOut15_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp
        (self.feed('Stack7_tmpOut15_spConv1',
                   'Stack7_tmpOut15_U')
         .add(name='Stack7_tmpOut15_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut15_Qtemp3'))
# tmpOut15 att pfeat
        (self.feed('Stack7_tmpOut15_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut15_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut15_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut15_pfeat_multiply'))

        (self.feed('Stack7_tmpOut15_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut15_s', padding='SAME'))
...
# attention map for part16
# tmpOut16 att U input: Stack7_att_pfeat_multiply
        (self.feed('Stack7_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut16_U', padding='SAME'))
# tmpOut16 att i=1 conv  C(1)
        with tf.variable_scope('Stack7_tmpOut16_share_param', reuse=False):
            (self.feed('Stack7_tmpOut16_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp
        (self.feed('Stack7_tmpOut16_spConv1',
                   'Stack7_tmpOut16_U')
         .add(name='Stack7_tmpOut16_Qtemp1_add')
         .sigmoid(name='Stack7_tmpOut16_Qtemp1'))

# tmpOut16 att i=2 conv  C(2)
        with tf.variable_scope('Stack7_tmpOut16_share_param', reuse=True):
            (self.feed('Stack7_tmpOut16_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp2
        (self.feed('Stack7_tmpOut16_spConv1',
                   'Stack7_tmpOut16_U')
         .add(name='Stack7_tmpOut16_Qtemp2_add')
         .sigmoid(name='Stack7_tmpOut16_Qtemp2'))

# tmpOut16 att i=3 conv  C(3)
        with tf.variable_scope('Stack7_tmpOut16_share_param', reuse=True):
            (self.feed('Stack7_tmpOut16_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp
        (self.feed('Stack7_tmpOut16_spConv1',
                   'Stack7_tmpOut16_U')
         .add(name='Stack7_tmpOut16_Qtemp3_add')
         .sigmoid(name='Stack7_tmpOut16_Qtemp3'))
# tmpOut16 att pfeat
        (self.feed('Stack7_tmpOut16_Qtemp3')
         .replicate(256, 3, name='Stack7_tmpOut16_pfeat_replicate'))

        (self.feed('Stack7_att_pfeat_multiply',
                   'Stack7_tmpOut16_pfeat_replicate')
         .multiply2(name='Stack7_tmpOut16_pfeat_multiply'))

        (self.feed('Stack7_tmpOut16_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack7_tmpOut16_s', padding='SAME'))


        (self.feed('Stack7_tmpOut1_s',
                   'Stack7_tmpOut2_s',
                   'Stack7_tmpOut3_s',
                   'Stack7_tmpOut4_s',
                   'Stack7_tmpOut5_s',
                   ...
                   'Stack7_tmpOut15_s',
                   'Stack7_tmpOut16_s')
         .stack(axis = 3,  name='Stack7_Heatmap'))        
...
# attention map for part1
# tmpOut1 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut1_U', padding='SAME'))
# tmpOut1 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut1_share_param', reuse=False):
            (self.feed('Stack8_tmpOut1_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp
        (self.feed('Stack8_tmpOut1_spConv1',
                   'Stack8_tmpOut1_U')
         .add(name='Stack8_tmpOut1_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut1_Qtemp1'))

# tmpOut1 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut1_share_param', reuse=True):
            (self.feed('Stack8_tmpOut1_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp2
        (self.feed('Stack8_tmpOut1_spConv1',
                   'Stack8_tmpOut1_U')
         .add(name='Stack8_tmpOut1_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut1_Qtemp2'))

# tmpOut1 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut1_share_param', reuse=True):
            (self.feed('Stack8_tmpOut1_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut1_spConv1', padding='SAME'))
# tmpOut1 att Qtemp
        (self.feed('Stack8_tmpOut1_spConv1',
                   'Stack8_tmpOut1_U')
         .add(name='Stack8_tmpOut1_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut1_Qtemp3'))
# tmpOut1 att pfeat
        (self.feed('Stack8_tmpOut1_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut1_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut1_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut1_pfeat_multiply'))

        (self.feed('Stack8_tmpOut1_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut1_s', padding='SAME'))




# attention map for part2
# tmpOut2 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut2_U', padding='SAME'))
# tmpOut2 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut2_share_param', reuse=False):
            (self.feed('Stack8_tmpOut2_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp
        (self.feed('Stack8_tmpOut2_spConv1',
                   'Stack8_tmpOut2_U')
         .add(name='Stack8_tmpOut2_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut2_Qtemp1'))

# tmpOut2 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut2_share_param', reuse=True):
            (self.feed('Stack8_tmpOut2_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp2
        (self.feed('Stack8_tmpOut2_spConv1',
                   'Stack8_tmpOut2_U')
         .add(name='Stack8_tmpOut2_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut2_Qtemp2'))

# tmpOut2 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut2_share_param', reuse=True):
            (self.feed('Stack8_tmpOut2_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut2_spConv1', padding='SAME'))
# tmpOut2 att Qtemp
        (self.feed('Stack8_tmpOut2_spConv1',
                   'Stack8_tmpOut2_U')
         .add(name='Stack8_tmpOut2_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut2_Qtemp3'))
# tmpOut2 att pfeat
        (self.feed('Stack8_tmpOut2_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut2_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut2_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut2_pfeat_multiply'))

        (self.feed('Stack8_tmpOut2_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut2_s', padding='SAME'))




# attention map for part3
# tmpOut3 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut3_U', padding='SAME'))
# tmpOut3 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut3_share_param', reuse=False):
            (self.feed('Stack8_tmpOut3_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp
        (self.feed('Stack8_tmpOut3_spConv1',
                   'Stack8_tmpOut3_U')
         .add(name='Stack8_tmpOut3_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut3_Qtemp1'))

# tmpOut3 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut3_share_param', reuse=True):
            (self.feed('Stack8_tmpOut3_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp2
        (self.feed('Stack8_tmpOut3_spConv1',
                   'Stack8_tmpOut3_U')
         .add(name='Stack8_tmpOut3_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut3_Qtemp2'))

# tmpOut3 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut3_share_param', reuse=True):
            (self.feed('Stack8_tmpOut3_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut3_spConv1', padding='SAME'))
# tmpOut3 att Qtemp
        (self.feed('Stack8_tmpOut3_spConv1',
                   'Stack8_tmpOut3_U')
         .add(name='Stack8_tmpOut3_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut3_Qtemp3'))
# tmpOut3 att pfeat
        (self.feed('Stack8_tmpOut3_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut3_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut3_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut3_pfeat_multiply'))

        (self.feed('Stack8_tmpOut3_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut3_s', padding='SAME'))
...
# attention map for part4
# tmpOut4 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut4_U', padding='SAME'))
# tmpOut4 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut4_share_param', reuse=False):
            (self.feed('Stack8_tmpOut4_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp
        (self.feed('Stack8_tmpOut4_spConv1',
                   'Stack8_tmpOut4_U')
         .add(name='Stack8_tmpOut4_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut4_Qtemp1'))

# tmpOut4 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut4_share_param', reuse=True):
            (self.feed('Stack8_tmpOut4_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp2
        (self.feed('Stack8_tmpOut4_spConv1',
                   'Stack8_tmpOut4_U')
         .add(name='Stack8_tmpOut4_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut4_Qtemp2'))

# tmpOut4 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut4_share_param', reuse=True):
            (self.feed('Stack8_tmpOut4_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut4_spConv1', padding='SAME'))
# tmpOut4 att Qtemp
        (self.feed('Stack8_tmpOut4_spConv1',
                   'Stack8_tmpOut4_U')
         .add(name='Stack8_tmpOut4_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut4_Qtemp3'))
# tmpOut4 att pfeat
        (self.feed('Stack8_tmpOut4_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut4_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut4_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut4_pfeat_multiply'))

        (self.feed('Stack8_tmpOut4_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut4_s', padding='SAME'))
...
# attention map for part5
# tmpOut5 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut5_U', padding='SAME'))
# tmpOut5 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut5_share_param', reuse=False):
            (self.feed('Stack8_tmpOut5_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp
        (self.feed('Stack8_tmpOut5_spConv1',
                   'Stack8_tmpOut5_U')
         .add(name='Stack8_tmpOut5_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut5_Qtemp1'))

# tmpOut5 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut5_share_param', reuse=True):
            (self.feed('Stack8_tmpOut5_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp2
        (self.feed('Stack8_tmpOut5_spConv1',
                   'Stack8_tmpOut5_U')
         .add(name='Stack8_tmpOut5_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut5_Qtemp2'))

# tmpOut5 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut5_share_param', reuse=True):
            (self.feed('Stack8_tmpOut5_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut5_spConv1', padding='SAME'))
# tmpOut5 att Qtemp
        (self.feed('Stack8_tmpOut5_spConv1',
                   'Stack8_tmpOut5_U')
         .add(name='Stack8_tmpOut5_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut5_Qtemp3'))
# tmpOut5 att pfeat
        (self.feed('Stack8_tmpOut5_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut5_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut5_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut5_pfeat_multiply'))

        (self.feed('Stack8_tmpOut5_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut5_s', padding='SAME'))
...
# attention map for part6
# tmpOut6 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut6_U', padding='SAME'))
# tmpOut6 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut6_share_param', reuse=False):
            (self.feed('Stack8_tmpOut6_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp
        (self.feed('Stack8_tmpOut6_spConv1',
                   'Stack8_tmpOut6_U')
         .add(name='Stack8_tmpOut6_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut6_Qtemp1'))

# tmpOut6 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut6_share_param', reuse=True):
            (self.feed('Stack8_tmpOut6_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp2
        (self.feed('Stack8_tmpOut6_spConv1',
                   'Stack8_tmpOut6_U')
         .add(name='Stack8_tmpOut6_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut6_Qtemp2'))

# tmpOut6 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut6_share_param', reuse=True):
            (self.feed('Stack8_tmpOut6_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut6_spConv1', padding='SAME'))
# tmpOut6 att Qtemp
        (self.feed('Stack8_tmpOut6_spConv1',
                   'Stack8_tmpOut6_U')
         .add(name='Stack8_tmpOut6_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut6_Qtemp3'))
# tmpOut6 att pfeat
        (self.feed('Stack8_tmpOut6_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut6_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut6_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut6_pfeat_multiply'))

        (self.feed('Stack8_tmpOut6_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut6_s', padding='SAME'))
...
# attention map for part7
# tmpOut7 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut7_U', padding='SAME'))
# tmpOut7 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut7_share_param', reuse=False):
            (self.feed('Stack8_tmpOut7_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp
        (self.feed('Stack8_tmpOut7_spConv1',
                   'Stack8_tmpOut7_U')
         .add(name='Stack8_tmpOut7_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut7_Qtemp1'))

# tmpOut7 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut7_share_param', reuse=True):
            (self.feed('Stack8_tmpOut7_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp2
        (self.feed('Stack8_tmpOut7_spConv1',
                   'Stack8_tmpOut7_U')
         .add(name='Stack8_tmpOut7_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut7_Qtemp2'))

# tmpOut7 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut7_share_param', reuse=True):
            (self.feed('Stack8_tmpOut7_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut7_spConv1', padding='SAME'))
# tmpOut7 att Qtemp
        (self.feed('Stack8_tmpOut7_spConv1',
                   'Stack8_tmpOut7_U')
         .add(name='Stack8_tmpOut7_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut7_Qtemp3'))
# tmpOut7 att pfeat
        (self.feed('Stack8_tmpOut7_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut7_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut7_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut7_pfeat_multiply'))

        (self.feed('Stack8_tmpOut7_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut7_s', padding='SAME'))
...
# attention map for part8
# tmpOut8 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut8_U', padding='SAME'))
# tmpOut8 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut8_share_param', reuse=False):
            (self.feed('Stack8_tmpOut8_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp
        (self.feed('Stack8_tmpOut8_spConv1',
                   'Stack8_tmpOut8_U')
         .add(name='Stack8_tmpOut8_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut8_Qtemp1'))

# tmpOut8 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut8_share_param', reuse=True):
            (self.feed('Stack8_tmpOut8_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp2
        (self.feed('Stack8_tmpOut8_spConv1',
                   'Stack8_tmpOut8_U')
         .add(name='Stack8_tmpOut8_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut8_Qtemp2'))

# tmpOut8 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut8_share_param', reuse=True):
            (self.feed('Stack8_tmpOut8_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut8_spConv1', padding='SAME'))
# tmpOut8 att Qtemp
        (self.feed('Stack8_tmpOut8_spConv1',
                   'Stack8_tmpOut8_U')
         .add(name='Stack8_tmpOut8_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut8_Qtemp3'))
# tmpOut8 att pfeat
        (self.feed('Stack8_tmpOut8_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut8_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut8_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut8_pfeat_multiply'))

        (self.feed('Stack8_tmpOut8_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut8_s', padding='SAME'))
...
# attention map for part9
# tmpOut9 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut9_U', padding='SAME'))
# tmpOut9 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut9_share_param', reuse=False):
            (self.feed('Stack8_tmpOut9_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp
        (self.feed('Stack8_tmpOut9_spConv1',
                   'Stack8_tmpOut9_U')
         .add(name='Stack8_tmpOut9_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut9_Qtemp1'))

# tmpOut9 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut9_share_param', reuse=True):
            (self.feed('Stack8_tmpOut9_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp2
        (self.feed('Stack8_tmpOut9_spConv1',
                   'Stack8_tmpOut9_U')
         .add(name='Stack8_tmpOut9_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut9_Qtemp2'))

# tmpOut9 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut9_share_param', reuse=True):
            (self.feed('Stack8_tmpOut9_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut9_spConv1', padding='SAME'))
# tmpOut9 att Qtemp
        (self.feed('Stack8_tmpOut9_spConv1',
                   'Stack8_tmpOut9_U')
         .add(name='Stack8_tmpOut9_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut9_Qtemp3'))
# tmpOut9 att pfeat
        (self.feed('Stack8_tmpOut9_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut9_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut9_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut9_pfeat_multiply'))

        (self.feed('Stack8_tmpOut9_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut9_s', padding='SAME'))
...
# attention map for part10
# tmpOut10 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut10_U', padding='SAME'))
# tmpOut10 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut10_share_param', reuse=False):
            (self.feed('Stack8_tmpOut10_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp
        (self.feed('Stack8_tmpOut10_spConv1',
                   'Stack8_tmpOut10_U')
         .add(name='Stack8_tmpOut10_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut10_Qtemp1'))

# tmpOut10 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut10_share_param', reuse=True):
            (self.feed('Stack8_tmpOut10_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp2
        (self.feed('Stack8_tmpOut10_spConv1',
                   'Stack8_tmpOut10_U')
         .add(name='Stack8_tmpOut10_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut10_Qtemp2'))

# tmpOut10 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut10_share_param', reuse=True):
            (self.feed('Stack8_tmpOut10_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut10_spConv1', padding='SAME'))
# tmpOut10 att Qtemp
        (self.feed('Stack8_tmpOut10_spConv1',
                   'Stack8_tmpOut10_U')
         .add(name='Stack8_tmpOut10_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut10_Qtemp3'))
# tmpOut10 att pfeat
        (self.feed('Stack8_tmpOut10_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut10_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut10_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut10_pfeat_multiply'))

        (self.feed('Stack8_tmpOut10_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut10_s', padding='SAME'))
...
# attention map for part11
# tmpOut11 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut11_U', padding='SAME'))
# tmpOut11 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut11_share_param', reuse=False):
            (self.feed('Stack8_tmpOut11_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp
        (self.feed('Stack8_tmpOut11_spConv1',
                   'Stack8_tmpOut11_U')
         .add(name='Stack8_tmpOut11_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut11_Qtemp1'))

# tmpOut11 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut11_share_param', reuse=True):
            (self.feed('Stack8_tmpOut11_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp2
        (self.feed('Stack8_tmpOut11_spConv1',
                   'Stack8_tmpOut11_U')
         .add(name='Stack8_tmpOut11_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut11_Qtemp2'))

# tmpOut11 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut11_share_param', reuse=True):
            (self.feed('Stack8_tmpOut11_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut11_spConv1', padding='SAME'))
# tmpOut11 att Qtemp
        (self.feed('Stack8_tmpOut11_spConv1',
                   'Stack8_tmpOut11_U')
         .add(name='Stack8_tmpOut11_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut11_Qtemp3'))
# tmpOut11 att pfeat
        (self.feed('Stack8_tmpOut11_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut11_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut11_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut11_pfeat_multiply'))

        (self.feed('Stack8_tmpOut11_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut11_s', padding='SAME'))
...
# attention map for part12
# tmpOut12 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut12_U', padding='SAME'))
# tmpOut12 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut12_share_param', reuse=False):
            (self.feed('Stack8_tmpOut12_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp
        (self.feed('Stack8_tmpOut12_spConv1',
                   'Stack8_tmpOut12_U')
         .add(name='Stack8_tmpOut12_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut12_Qtemp1'))

# tmpOut12 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut12_share_param', reuse=True):
            (self.feed('Stack8_tmpOut12_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp2
        (self.feed('Stack8_tmpOut12_spConv1',
                   'Stack8_tmpOut12_U')
         .add(name='Stack8_tmpOut12_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut12_Qtemp2'))

# tmpOut12 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut12_share_param', reuse=True):
            (self.feed('Stack8_tmpOut12_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut12_spConv1', padding='SAME'))
# tmpOut12 att Qtemp
        (self.feed('Stack8_tmpOut12_spConv1',
                   'Stack8_tmpOut12_U')
         .add(name='Stack8_tmpOut12_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut12_Qtemp3'))
# tmpOut12 att pfeat
        (self.feed('Stack8_tmpOut12_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut12_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut12_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut12_pfeat_multiply'))

        (self.feed('Stack8_tmpOut12_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut12_s', padding='SAME'))
...
# attention map for part13
# tmpOut13 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut13_U', padding='SAME'))
# tmpOut13 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut13_share_param', reuse=False):
            (self.feed('Stack8_tmpOut13_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp
        (self.feed('Stack8_tmpOut13_spConv1',
                   'Stack8_tmpOut13_U')
         .add(name='Stack8_tmpOut13_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut13_Qtemp1'))

# tmpOut13 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut13_share_param', reuse=True):
            (self.feed('Stack8_tmpOut13_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp2
        (self.feed('Stack8_tmpOut13_spConv1',
                   'Stack8_tmpOut13_U')
         .add(name='Stack8_tmpOut13_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut13_Qtemp2'))

# tmpOut13 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut13_share_param', reuse=True):
            (self.feed('Stack8_tmpOut13_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut13_spConv1', padding='SAME'))
# tmpOut13 att Qtemp
        (self.feed('Stack8_tmpOut13_spConv1',
                   'Stack8_tmpOut13_U')
         .add(name='Stack8_tmpOut13_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut13_Qtemp3'))
# tmpOut13 att pfeat
        (self.feed('Stack8_tmpOut13_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut13_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut13_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut13_pfeat_multiply'))

        (self.feed('Stack8_tmpOut13_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut13_s', padding='SAME'))
...
# attention map for part14
# tmpOut14 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut14_U', padding='SAME'))
# tmpOut14 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut14_share_param', reuse=False):
            (self.feed('Stack8_tmpOut14_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp
        (self.feed('Stack8_tmpOut14_spConv1',
                   'Stack8_tmpOut14_U')
         .add(name='Stack8_tmpOut14_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut14_Qtemp1'))

# tmpOut14 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut14_share_param', reuse=True):
            (self.feed('Stack8_tmpOut14_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp2
        (self.feed('Stack8_tmpOut14_spConv1',
                   'Stack8_tmpOut14_U')
         .add(name='Stack8_tmpOut14_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut14_Qtemp2'))

# tmpOut14 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut14_share_param', reuse=True):
            (self.feed('Stack8_tmpOut14_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut14_spConv1', padding='SAME'))
# tmpOut14 att Qtemp
        (self.feed('Stack8_tmpOut14_spConv1',
                   'Stack8_tmpOut14_U')
         .add(name='Stack8_tmpOut14_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut14_Qtemp3'))
# tmpOut14 att pfeat
        (self.feed('Stack8_tmpOut14_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut14_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut14_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut14_pfeat_multiply'))

        (self.feed('Stack8_tmpOut14_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut14_s', padding='SAME'))
...
# attention map for part15
# tmpOut15 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut15_U', padding='SAME'))
# tmpOut15 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut15_share_param', reuse=False):
            (self.feed('Stack8_tmpOut15_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp
        (self.feed('Stack8_tmpOut15_spConv1',
                   'Stack8_tmpOut15_U')
         .add(name='Stack8_tmpOut15_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut15_Qtemp1'))

# tmpOut15 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut15_share_param', reuse=True):
            (self.feed('Stack8_tmpOut15_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp2
        (self.feed('Stack8_tmpOut15_spConv1',
                   'Stack8_tmpOut15_U')
         .add(name='Stack8_tmpOut15_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut15_Qtemp2'))

# tmpOut15 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut15_share_param', reuse=True):
            (self.feed('Stack8_tmpOut15_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut15_spConv1', padding='SAME'))
# tmpOut15 att Qtemp
        (self.feed('Stack8_tmpOut15_spConv1',
                   'Stack8_tmpOut15_U')
         .add(name='Stack8_tmpOut15_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut15_Qtemp3'))
# tmpOut15 att pfeat
        (self.feed('Stack8_tmpOut15_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut15_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut15_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut15_pfeat_multiply'))

        (self.feed('Stack8_tmpOut15_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut15_s', padding='SAME'))
...
# attention map for part16
# tmpOut16 att U input: Stack8_att_pfeat_multiply
        (self.feed('Stack8_att_pfeat_multiply')
             .conv(3, 3, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut16_U', padding='SAME'))
# tmpOut16 att i=1 conv  C(1)
        with tf.variable_scope('Stack8_tmpOut16_share_param', reuse=False):
            (self.feed('Stack8_tmpOut16_U')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp
        (self.feed('Stack8_tmpOut16_spConv1',
                   'Stack8_tmpOut16_U')
         .add(name='Stack8_tmpOut16_Qtemp1_add')
         .sigmoid(name='Stack8_tmpOut16_Qtemp1'))

# tmpOut16 att i=2 conv  C(2)
        with tf.variable_scope('Stack8_tmpOut16_share_param', reuse=True):
            (self.feed('Stack8_tmpOut16_Qtemp1')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp2
        (self.feed('Stack8_tmpOut16_spConv1',
                   'Stack8_tmpOut16_U')
         .add(name='Stack8_tmpOut16_Qtemp2_add')
         .sigmoid(name='Stack8_tmpOut16_Qtemp2'))

# tmpOut16 att i=3 conv  C(3)
        with tf.variable_scope('Stack8_tmpOut16_share_param', reuse=True):
            (self.feed('Stack8_tmpOut16_Qtemp2')
                 .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut16_spConv1', padding='SAME'))
# tmpOut16 att Qtemp
        (self.feed('Stack8_tmpOut16_spConv1',
                   'Stack8_tmpOut16_U')
         .add(name='Stack8_tmpOut16_Qtemp3_add')
         .sigmoid(name='Stack8_tmpOut16_Qtemp3'))
# tmpOut16 att pfeat
        (self.feed('Stack8_tmpOut16_Qtemp3')
         .replicate(512, 3, name='Stack8_tmpOut16_pfeat_replicate'))

        (self.feed('Stack8_att_pfeat_multiply',
                   'Stack8_tmpOut16_pfeat_replicate')
         .multiply2(name='Stack8_tmpOut16_pfeat_multiply'))

        (self.feed('Stack8_tmpOut16_pfeat_multiply')
             .conv(1, 1, 1, 1, 1, biased=True, relu=False, name='Stack8_tmpOut16_s', padding='SAME'))


        (self.feed('Stack8_tmpOut1_s',
                   'Stack8_tmpOut2_s',
                   'Stack8_tmpOut3_s',
                   'Stack8_tmpOut4_s',
                   'Stack8_tmpOut5_s',
                   ...
                   'Stack8_tmpOut15_s',
                   'Stack8_tmpOut16_s')
         .stack( axis = 3, name='Stack8_Heatmap'))        
